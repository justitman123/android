...
class JStompSto {
  ...
  static JStompSto _instance;

  factory JStompSto() => _getInstance();

  static JStompSto get instance => _getInstance();
  ...
  /// 返回实例对象
  ///
  static JStompSto _getInstance() {
    if (_instance == null) {
      _instance = JStompSto._init();
    }
    return _instance;
  }
