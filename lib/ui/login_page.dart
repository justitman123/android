...
class _LoginPageState extends State<LoginPage>
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          onSaved: (val) {
                            signupEmailController.text = val;
                          },
                        ),
                      ),
                      Container(
  ...
  Future<String> singUp() async {
    String GOOGLE_AUTH_URL = 'http://192.168.43.104:8060/uaa/auth/signup';
...
//    print(post2);
  ...
  Future singIn() async {
    String GOOGLE_AUTH_URL = 'http://192.168.43.104:8060/uaa/auth/login';
    Map<String, String> body = {
